...
public class TransformPCMDFDToPrologWorkflowImpl implements TransformPCMDFDToPrologWorkflow {
    ...
    public TransformPCMDFDToPrologWorkflowImpl(TransformPCMDFDtoPrologJob<? extends KeyValueMDSDBlackboard> job, IProgressMonitor monitor, WorkflowExceptionHandler handler) {
    ...
    protected static BlackboardBasedWorkflow<KeyValueMDSDBlackboard> createWorkflow(TransformPCMDFDtoPrologJob<? extends KeyValueMDSDBlackboard> job, IProgressMonitor monitor, WorkflowExceptionHandler handler, KeyValueMDSDBlackboard blackboard) {
    ...
    public Optional<String> getPrologProgram() {
        return blackboard.get(prologProgramKey).map(String.class::cast);
    }
